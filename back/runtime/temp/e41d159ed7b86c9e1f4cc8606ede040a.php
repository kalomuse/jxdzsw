...
<script>
    $(document).ready(function () {
        ...
        var config = [
            {'str': '地址', 'name':'address', width: 400},
            {'str': '服务', 'name':'server', width: 400},

        ];
        var params = {
        }

        jgrid_init($grid, config, params, 600, '/index/company/' );
