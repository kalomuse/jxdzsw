...
<script>
    $(document).ready(function () {
        ...
        var config = [
            {'str': '手机', 'name': 'mobile', align:'center', editable: false},
            {'str': '邮件', 'name': 'email', width: 180, align:'center', editable: false},
            {'str': '内容', 'name': 'content', width:900, editable: false},
        ];
        var params = {

        }
        jgrid_init($grid, config, params, 120, '/admin/message/' );
